...
$sql="insert into products(category,subCategory,productName,productCompany,productPrice,productDescription,shippingCharge,productAvailability,productImage1,productImage2,productImage3,productPriceBeforeDiscount) 
...
$sql ="INSERT INTO `tblinventory` (`PRODUCTID`, `IN_DATE`, `STOCKIN`,REMAINING) VALUES ('$myid',NOW(),'$qty','$qty')";
mysql_query($sql);
...
<div class="controls">
<input type="text"    name="qty"  placeholder="Quantity" class="span8 tip" required>
</div>
</div>
